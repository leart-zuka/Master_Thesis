...
r3 = r_atom_in_cavity(
    d_c_V, d_a_V, g_sp_KC, kappa, kappa_oc, MM_rf, MM_fc, gamma_5P32_5S
)
r4 = r_atom_in_cavity(
    d_c_pi, d_a_pi, g_sm_KC, kappa, kappa_oc, MM_rf, MM_fc, gamma_5P32_5S
)
...
r_data = [["r1_sp", r1_sp], ["r2", r2], ["r3", r3], ["r4", r4]]
...
ax[0, 0].add_artist(
    AnnotationBbox(OffsetImage(image_sp_up, zoom=0.34), (0.42, 0.35), frameon=True)
)
...
ax[0, 1].add_artist(
    AnnotationBbox(OffsetImage(image_sp_down, zoom=0.34), (0.42, 0.35), frameon=True)
)
...
ax[1, 1].add_artist(
    AnnotationBbox(OffsetImage(image_pi_down, zoom=0.34), (0.42, 0.35), frameon=True)
)
