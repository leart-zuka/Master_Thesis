...
def plot_drive_pi_and_v(
    ...
    ax1.plot(tlist, result_0_pi.e_data["n_cav_pi_2"], label=r"$n_{\pi}$")
    ax1.plot(tlist, result_0_pi.e_data["n_cav_v_2"], label=r"$n_V$")
    ax1.set_xlabel("Time")
    ax1.set_ylabel("Photon number")
    ax1.legend()
    ...
    ax2.plot(tlist, result_1_pi.e_data["n_cav_pi_2"], label=r"$n_{\pi}$")
    ax2.plot(tlist, result_1_pi.e_data["n_cav_v_2"], label=r"$n_V$")
    ax2.set_xlabel("Time")
    ...
    ax3.plot(tlist, result_0_v.e_data["n_cav_pi_2"], label=r"$n_{\pi}$")
    ax3.plot(tlist, result_0_v.e_data["n_cav_v_2"], label=r"$n_V$")
    ax3.set_xlabel("Time")
    ...
    ax4.plot(tlist, result_1_v.e_data["n_cav_pi_2"], label=r"$n_{\pi}$")
    ax4.plot(tlist, result_1_v.e_data["n_cav_v_2"], label=r"$n_V$")
    ax4.set_xlabel("Time")
