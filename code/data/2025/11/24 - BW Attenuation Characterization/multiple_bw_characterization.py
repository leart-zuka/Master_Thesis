...
baseline_h_file = "multiple_bw_baseline_h.csv"
baseline_v_file = "multiple_bw_baseline_v.csv"
...
files = {
    "2 BW": ("multiple_bw_2_windows_h.csv", "multiple_bw_2_windows_v.csv"),
    "4 BW": ("multiple_bw_4_windows_h.csv", "multiple_bw_4_windows_v.csv"),
    "6 BW": ("multiple_bw_6_windows_h.csv", "multiple_bw_6_windows_v.csv"),
}
