...
df_h_compare = pd.read_csv("H_transmission_1st_dichroic.csv", sep=";", skiprows=8)
df_v_compare = pd.read_csv("V_transmission_1st_dichroic.csv", sep=";", skiprows=8)

plot_average_poincare_point(df_h, df_v, df_h_compare, df_v_compare, comparisson)


comparisson = "reflection from 2nd dichroic"
df_h_compare = pd.read_csv("H_reflection_2nd_dichroic.csv", sep=";", skiprows=8)
df_v_compare = pd.read_csv("V_reflection_2nd_dichroic.csv", sep=";", skiprows=8)

plot_average_poincare_point(df_h, df_v, df_h_compare, df_v_compare, comparisson)

comparisson = "transmission through 2nd dichroic"
df_h_compare = pd.read_csv(
    "H_transmission_2nd_dichroic_after_cavity.csv", sep=";", skiprows=8
)
df_v_compare = pd.read_csv(
    "V_transmission_2nd_dichroic_after_cavity.csv", sep=";", skiprows=8
)

plot_average_poincare_point(df_h, df_v, df_h_compare, df_v_compare, comparisson)


comparisson = "transmission through 2nd dichroic w compensation after reflection"
df_h_compare = pd.read_csv(
    "H_transmission_2nd_dichroic_after_cavity_extra_compensation_waveplates.csv",
    sep=";",
    skiprows=8,
)
df_v_compare = pd.read_csv(
    "V_transmission_2nd_dichroic_after_cavity_extra_compensation_waveplates.csv",
    sep=";",
    skiprows=8,
)
...
comparisson = "transmission through 2nd dichroic w compensation after reflection with extra compensation waveplates infront of cavity"

df_h_compare = pd.read_csv(
    "H_transmission_through_2nd_dichroic_with_extra_compensation_wp_infront_of_cav.csv",
    sep=";",
    skiprows=8,
)
df_v_compare = pd.read_csv(
    "V_transmission_through_2nd_dichroic_with_extra_compensation_wp_infront_of_cav.csv",
    sep=";",
    skiprows=8,
)
