...
df_h_compare = pd.read_csv("H_transmission_2nd_dichroic.csv", sep=";", skiprows=8)
df_v_compare = pd.read_csv("V_transmission_2nd_dichroic.csv", sep=";", skiprows=8)
...
df_h_compare = pd.read_csv(
    "H_transmission_2nd_dichroic_extra_compensation_waveplates.csv", sep=";", skiprows=8
)
df_v_compare = pd.read_csv(
    "V_transmission_2nd_dichroic_extra_compensation_waveplates.csv", sep=";", skiprows=8
)
