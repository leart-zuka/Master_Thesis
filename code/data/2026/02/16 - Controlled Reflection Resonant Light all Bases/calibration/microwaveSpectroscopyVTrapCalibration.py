...
if __name__ == '__main__':
    ...
    measurements = "16_02_26_VTrap_Calibration_13"
    filetype : str = ".h5"
        ...
        if fit_peaks:
            for j in range(len(modMWspec)):
                ...
                Delta[i] = np.round(res_MWspec[1].best_values['foff'], 1) - np.round(res_MWspec[0].best_values['foff'],
                                                                                     1)
                Delta_stderr[i] = np.round(res_MWspec[1].params['foff'].stderr, 2) + np.round(
                    res_MWspec[0].params['foff'].stderr, 2)
