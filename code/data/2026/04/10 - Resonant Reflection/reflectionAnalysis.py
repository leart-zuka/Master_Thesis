...
if __name__ == "__main__":
    ...
    file = "09_04_26_AP_Gate_CNOT_RL_Basis_1e_m5_photons_1_2"
    ...
    cnot_files_trap_on = [
        "09_04_26_AP_Gate_CNOT_RL_Basis_1e_m5_photons_1_3",
        "09_04_26_AP_Gate_CNOT_RL_Basis_1e_m5_photons_1_4",
        "09_04_26_AP_Gate_CNOT_RL_Basis_1e_m5_photons_1_1",
        "09_04_26_AP_Gate_CNOT_RL_Basis_1e_m5_photons_1_2",
    ]
    ...
    plot_gate_3d(
        cnot_gate.T,
        cnot_err.T,
        title=r"CNOT Gate (RL basis) @ $\bar{n}=1e^{-5}$",
        file_name="CNOT (RL) @ mean photon of 1e_m5",
        fidelity_indices=[(0, 0), (1, 1), (2, 3)],
        atom_basis=["|1⟩", "|0⟩"],
        photon_basis=["R", "L"],
        save_fig=True,
        # show_fig=True,
