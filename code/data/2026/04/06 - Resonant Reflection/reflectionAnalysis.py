...
class Analyzer:
    ...
    def reflection_analysis(
        ...
        trials_1_photons_ps = 0
        trials_g1_photons_ps = 0
        ...
        print(
            f"Efficiency: [yellow]{efficiency * 100:.2f} ± {efficiency_err * 100:.2f}%[/yellow]"
        )
        self.data_arr = None
...
if __name__ == "__main__":
    ...
    file = "06_04_26_AP_Gate_CPF_Basis_02_photons_3"
    ...
    ParamDictReflection_trap_off: ReflectionGateT = {
        ...
        # "pulse_delay": 38.3e-6,  # Trap on
        # "pulse_delay": 39.5e-6,  # Trap on
