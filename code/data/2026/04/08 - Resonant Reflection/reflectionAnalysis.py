...
if __name__ == "__main__":
    ...
    file = "08_04_26_AP_Gate_02_photons_RL_basis_sending_L_atom_1_1mus_SD_1mus_later_1"
    ...
    ParamDictReflection_trap_off: ReflectionGateT = {
        ...
        # "pulse_delay": 39.6e-6,  # Trap on
        # "pulse_duration": 2.2e-6, # 2mus pulse
        # "pulse_duration": 0.6e-6,
        "pulse_duration": 1.2e-6, # 1mus pulse
        # "pulse_duration": .7e-6,  # 0.5mus pulse
        # "pulse_duration": 5.2e-6,   # 5 muS pulse
        # "pulse_duration": 10.2e-6,   # 10 muS pulse
        # "pulse_duration": 8.2e-6,   # 10 muS pulse


        # "pulse_duration": .59e-6,

        # "pulse_duration": .5e-6,
        # "pulse_duration": .4e-6,
        # "pulse_duration": .3e-6,

        # 1-1' pulse before SD and after gate
        # "pulse_delay_SD_after": 52e-6,

        # 1-1' pulse before SD and after gate
        # "pulse_delay_SD_after": 90e-6,

        # "pulse_delay_SD_after": 0.8e-6,  # Trap on
        "pulse_delay_SD_after": 1.5e-6,  # Trap on
        # "pulse_delay_SD_after": 2.8e-6,  # Trap on
        # "pulse_delay_SD_after": 3.5e-6,  # Trap on
        # "pulse_delay_SD_after": 2.6e-6,  # Trap on
        # "pulse_delay_SD_after": 1.1e-6,  # Trap on
        # "pulse_delay_SD_after": 1.2e-6,  # Trap on
        # "pulse_delay_SD_after": 1.21e-6,  # Trap on
        # "pulse_delay_SD_after": 1.3e-6,  # Trap on
        # "pulse_delay_SD_after": 1.4e-6,  # Trap on
        # "pulse_delay_SD_after": 1.5e-6,  # Trap on
        # "pulse_delay_SD_after": 1.5e-6,  # Trap on
    ...
    cnot_files_trap_on = [
        "06_04_26_AP_Gate_CPF_Basis_02_photons_3",
        "06_04_26_AP_Gate_CPF_Basis_02_photons_4",
        "06_04_26_AP_Gate_CPF_Basis_02_photons_1_1",
        "06_04_26_AP_Gate_CPF_Basis_02_photons_2",
    ]
    ...
    plot_gate_3d(
        cnot_gate.T,
        cnot_err.T,
        title="CPF Gate (HVL basis)",
        file_name="HV @ mean photon of 0_2 HV",
