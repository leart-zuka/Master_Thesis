...
class Analyzer:
    ...
    def post_selection(
        ...
        twot = 2.4 * mean_kc_counts  # two atom threshold
    ...
    def reflection_analysis(
        ...
        len_2 = int(np.floor(len(data_arr[self.sync_fast][:-1])/24))
...
if __name__ == "__main__":
    ...
    file = "17_03_26_AP_Gate_CNOT_AD_Basis_0_2_photons_A_atom_1"
    ...
    sum,ch4, ch7,ch_4_err, ch_7_err = analyzer.reflection_analysis(file_name=file, path="./", parameters=ParamDictReflection_trap_off, plot_histogram=False,post_select_sd=False)
    print(sum, ch4, ch7)
    ...
    for i, file in enumerate(cnot_files_trap_off):
        sum, ch4, ch7, ch_4_err, ch_7_err = analyzer.reflection_analysis(file_name=file, path="./", parameters=ParamDictReflection_trap_off,
                                                     plot_histogram=False, post_select_sd=False)
        if i < 2:
