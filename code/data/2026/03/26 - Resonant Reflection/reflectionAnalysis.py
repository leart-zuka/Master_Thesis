...
class Analyzer:
    ...
    def post_selection(
        ...
        wt_kc = 0.7 * mean_kc_counts  # witness threshold short cavity
        twot = 1.5 * mean_kc_counts  # two atom threshold
    ...
    def normal_mode_spectroscopy(
        ...
        print(f"Analyzing Normal Mode Spectroscopy of file [green]{file_post_selected}[/green]")
    ...
    def reflection_analysis(
        ...
        write_gate = [
            ...
            optical_pumping_gate[1]+ pulse_delay + pulse_duration,  # End of photon pulse
            optical_pumping_gate[1] + pulse_delay+pulse_duration + pulse_delay_SD,  # Start of SD
            optical_pumping_gate[1] +pulse_delay+pulse_duration + pulse_delay_SD + pulse_duration_SD,  # End of SD
        ]
        ...
        len_2 = int(np.floor(len(data_arr[self.sync_fast][:-1])/2))
        # len_2 = int(np.floor(len(data_arr[self.sync_fast][:-1])))

        for i in track(range(len_2)):
        ...
        ch_4_err = np.std(counts_ch_4)
        ch_7_err = np.std(counts_ch_7)

        self.data_arr = None

        return sum, ch_4, ch_7, ch_4_err,ch_7_err
...
if __name__ == "__main__":
    ...
    file = ("26_03_26_Resonant_Reflection_D_02_photons_atom_1_mach_zehnder_85_physics_lock_23_2")
    ...
    sum,ch4, ch7,ch_4_err, ch_7_err = analyzer.reflection_analysis(file_name=file, path="./", parameters=ParamDictReflection_trap_off, plot_histogram=False,post_select_sd=True)
    print(sum, ch4, ch7)
    print(ch4/sum, ch7/sum)

    exit()

    # cnot_files_trap_off = [
    #     "13_03_26_AP_Gate_CNOT_AD_Basis_0_2_photons_coupled_state_mach_zehnder_90_4_1",  # A, 1
    #     "13_03_26_AP_Gate_CNOT_AD_Basis_0_2_photons_coupled_state_mach_zehnder_90_4_2",  # D, 1
    # ]
    # cnot_files_trap_off = [
    #     "17_03_26_AP_Gate_CNOT_AD_Basis_0_2_photons_1_4_atom_1",  #
    #     "17_03_26_AP_Gate_CNOT_AD_Basis_0_2_photons_1_2_atom_1",  #
    #     "17_03_26_AP_Gate_CNOT_AD_Basis_0_2_photons_1_3_atom_0",  #
    #     "17_03_26_AP_Gate_CNOT_AD_Basis_0_2_photons_1_1_atom_0",  # 0,D
    # ]
    ...
    for i, file in enumerate(cnot_files_trap_off):
        sum, ch4, ch7, ch_4_err, ch_7_err = analyzer.reflection_analysis(file_name=file, path="./", parameters=ParamDictReflection_trap_off,
                                                     plot_histogram=False, post_select_sd=True)
        if i < 2:
