...
class AtomAnalysis:
    ...
    def dataEv_stateDetection(self, path: str, file_list: List[str], filetype: str = 'h5'):
        ...
        for filename in file_list:
            ...
            SD1gate = [301.9e-6+800e-6 + 147e-6, 301.9e-6+ 147e-6 + 8e-6 +800e-6]
            SD2gate = [612.1e-6+1600e-6+ 147e-6, 612.1e-6 + 147e-6+ 8e-6 +1600e-6]
            # SD2gate = SD1gate
...
if __name__ == '__main__':
    ...
    measurements = ["26_03_26_SD_110_1094_3"]
    filetype : str = ".h5"
