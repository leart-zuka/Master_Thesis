...
def plot_average_poincare_point(
    ...
    df_l,
    folder,
    mode: Literal["reflection", "transmission"],
    comparisson,
    ...
    df_h_mode = pd.read_csv(f"./{folder}/H_{mode}.csv", sep=";", skiprows=8)
    df_v_mode = pd.read_csv(f"./{folder}/V_{mode}.csv", sep=";", skiprows=8)
    df_a_mode = pd.read_csv(f"./{folder}/A_{mode}.csv", sep=";", skiprows=8)
    df_d_mode = pd.read_csv(f"./{folder}/D_{mode}.csv", sep=";", skiprows=8)
    df_r_mode = pd.read_csv(f"./{folder}/R_{mode}.csv", sep=";", skiprows=8)
    df_l_mode = pd.read_csv(f"./{folder}/L_{mode}.csv", sep=";", skiprows=8)
    ...
    plt.legend()
    plt.savefig(f"{comparisson}.svg", bbox_inches="tight", pad_inches=0.15)
    if show_plot:
        plt.show()
...
plot_average_poincare_point(
    ...
    "Angle of 6_703 deg",
    "transmission",
    "transmission_through_pellical_for_6_703_deg",
)
...
plot_average_poincare_point(
    ...
    "Angle of 6_703 deg",
    "reflection",
    "reflection_through_pellical_for_6_703_deg",
    show_plot=True,
)
...
#     "Angle of 4 deg",
#     "transmission",
#     "transmission_through_pellical_for_4_deg",
# )
#
# plot_average_poincare_point(
#     df_h,
...
#     "Angle of 4 deg",
#     "reflection",
#     "reflection_through_pellical_for_4_deg",
#     show_plot=True,
# )
