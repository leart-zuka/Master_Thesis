...
df_h_compare = pd.read_csv(
    "./data/H_transmission_first_dichroic.csv", sep=";", skiprows=8
)
df_v_compare = pd.read_csv(
    "./data/V_transmission_first_dichroic.csv", sep=";", skiprows=8
)
...
df_h_compare = pd.read_csv(
    "./data/H_transmission_second_dichroic_compensation_stage_1.csv",
    sep=";",
    skiprows=8,
)
df_v_compare = pd.read_csv(
    "./data/V_transmission_second_dichroic_compensation_stage_1.csv",
    sep=";",
    skiprows=8,
)
...
comparisson = (
    "Reflection from Cavity with extra compensation for Dichroic Mirrors and Cavity"
)
df_h_compare = pd.read_csv(
    "./data/H_reflection_cavity_with_comp_st_1_and_comp_infront_of_cavity_without_extra_rotation_to_h_and_v.csv",
    sep=";",
    skiprows=8,
)
df_v_compare = pd.read_csv(
    "./data/V_reflection_cavity_with_comp_st_1_and_comp_infront_of_cavity_without_extra_rotation_to_h_and_v.csv",
    sep=";",
    skiprows=8,
)
