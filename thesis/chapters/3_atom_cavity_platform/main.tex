...
The cavity fibers are fabricated using a $\text{CO}_2$ laser machining technique by previous member of the Quantum Dynamics division at MPQ. The process of machining technique is descibed in Manuel Brekenfeld's thesis~\cite{ManuelBThesis2023}. Changing the beam profile of the $\text{CO}_2$ laser allows for the fabrication of elliptical surfaces, as is the case for the short cavity. This leads to a cavity mode splitting, i.e., cavity birefringence, as shown in figure \ref{fig:cavity_transmission_profiles} \\
