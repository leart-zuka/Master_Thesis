...
Using \eqref{eq:analytical_reflection} and the values measured in section \ref{section:experimental_parameters_for_gate}, the following values for the reflection amplitudes are obtained:
