...
Using the time-domain simulation described in Appendix \notetome{include appendix chapter} with the parameters characterized in section \ref{section:experimental_parameters_for_gate}, the following reflection amplitudes are obtained
